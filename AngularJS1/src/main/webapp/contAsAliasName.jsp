	...
	var employees = [ {
				...
				vm.search=function(item)
				{
					if(vm.searchtext==undefined)
						...
						{
						if(item.fname.toLowerCase().indexOf(vm.searchtext.toLowerCase()) != -1
								|| item.lname.toLowerCase().indexOf(vm.searchtext.toLowerCase()) != -1)
							{
							return true;
							}
						}
...
<body ng-controller="control as mycontrol">
<input type="text" ng-model="mycontrol.searchtext" placeholder="name and salary">
...
<tr ng-repeat="emp in mycontrol.employees  | filter : mycontrol.search">
